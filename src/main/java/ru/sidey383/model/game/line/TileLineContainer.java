...
import ru.sidey383.model.game.PianoGame;
import ru.sidey383.model.game.line.TileChunk;
...
public class TileLineContainer implements TileLine {
    ...
    public void getTiles(Collection<Tile> tileCollection, long  startTime, long  endTime) {
        ...
        int endN = Math.min(tileChunks.length - 1, (int) (startTime / CHUNK_TIME));
